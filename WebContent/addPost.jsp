...
<div id="wrap">
  ...
  <div id="content-wrap">
    ...
    <div id="main"> 
      <form name="form1" action="addPost.do" method="POST" onsubmit="return isValidate(form1)">
	      <table width="80%" align="center">
	      	...
	      	<tr>
	      		<td>内容：</td>
	      		<td><textarea rows="36" name="content"></textarea></td>
	      	</tr>
	      	<tr>
	      		<td>&nbsp;</td>
	      		<td><input class="button" type="submit" value="发表"></td>
	      	</tr>
	      </table>	      
	  </form>
    </div>
